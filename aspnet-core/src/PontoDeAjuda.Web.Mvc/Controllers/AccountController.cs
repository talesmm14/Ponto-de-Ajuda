...
using PontoDeAjuda.Web.Models.Account;
using PontoDeAjuda.Web.Views.Shared.Components.TenantChange;

namespace PontoDeAjuda.Web.Controllers
{
    public class AccountController : PontoDeAjudaControllerBase
    {
