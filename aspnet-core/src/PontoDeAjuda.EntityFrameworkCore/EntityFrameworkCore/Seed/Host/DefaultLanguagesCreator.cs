...
namespace PontoDeAjuda.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = PontoDeAjudaConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(PontoDeAjudaDbContext context)
        {
            _context = context;
        }
